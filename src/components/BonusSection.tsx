    ...
    <section className="relative bg-[#0A1A2F] border-y border-[#142640] py-5 lg:py-6 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-row items-center justify-center gap-3 sm:gap-4">
          <div className="inline-flex items-center justify-center w-9 h-9 sm:w-11 sm:h-11 bg-brand-500 rounded-full shrink-0">
            <Gift className="w-4 h-4 sm:w-5 sm:h-5 text-slate-900" />
          </div>

          <h2 className="text-xs sm:text-base md:text-lg lg:text-xl font-bold text-white leading-tight whitespace-nowrap">
            Do każdej drukarki Zebra ZT411 <span className="text-brand-500">GRATIS:</span> rolka etykiet + taśma termotransferowa
          </h2>
        </div>
      </div>
    </section>

...
const specs = [
  ...
  { label: 'Druk bezpodkładowy (opcja)', value: 'Linerless — +50% etykiet na rolkę, tylko ZT411' },
  ...
  { label: 'Rodzaje nośników', value: 'Ciągłe, sztancowane, z nacięciami, z czarnymi znacznikami, linerless' },

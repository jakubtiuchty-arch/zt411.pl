      ...
      <main>
        ...
        <section className="relative bg-gradient-to-br from-[#0A1A2F] via-slate-900 to-[#142640] py-14 lg:py-20 overflow-hidden">
          ...
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="inline-block px-3 py-1 bg-brand-500/10 border border-brand-500/30 rounded-full text-brand-500 text-xs font-bold uppercase tracking-wider mb-4">
              Porównanie drukarek
            </div>

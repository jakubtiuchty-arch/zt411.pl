...
export const metadata: Metadata = {
  metadataBase: new URL('https://zt411.pl'),
  title: `Zebra ZT411 — drukarka przemysłowa od ${lowDisplay} zł netto | TAKMA`,
  description: `Zebra ZT411: drukarka termotransferowa 4", 203/300/600 dpi, 356 mm/s, RFID, Wi-Fi 6E, ekran 4,3". Od ${lowDisplay} zł netto. Partner Zebra — TAKMA.`,
  keywords: ['zebra zt411', 'zt411', 'drukarka przemysłowa zebra', 'zebra zt411 cena', 'drukarka termotransferowa', 'zt411 300 dpi', 'zt411 600 dpi', 'zt411 rfid', 'zt411 vs zt231', 'drukarka etykiet przemysłowa'],
  authors: [{ name: 'TAKMA Tadeusz Tiuchty', url: 'https://takma.com.pl' }],
  creator: 'TAKMA',
  publisher: 'TAKMA Tadeusz Tiuchty',
  robots: { index: true, follow: true, googleBot: { index: true, follow: true } },
  alternates: { canonical: 'https://zt411.pl' },
  openGraph: {
    type: 'website',
    locale: 'pl_PL',
    url: 'https://zt411.pl',
    siteName: 'zt411.pl — Zebra ZT411 | TAKMA',
    title: `Zebra ZT411 — drukarka przemysłowa od ${lowDisplay} zł | TAKMA`,
    description: `Przemysłowa drukarka Zebra ZT411: termotransferowa/termiczna, 4", do 600 dpi, 356 mm/s, RFID, Wi-Fi 6E. Od ${lowDisplay} zł netto.`,
    images: [{ url: '/images/zt411-hero.jpg', width: 1200, height: 630, alt: 'Drukarka przemysłowa Zebra ZT411 — partner TAKMA' }],
  },
  twitter: {
...
function JsonLd() {
  ...
  const product = {
    '@context': 'https://schema.org',
    '@type': 'Product',
    '@id': 'https://zt411.pl/#product',
    name: 'Zebra ZT411',
    alternateName: ['Drukarka Zebra ZT411', 'Drukarka przemysłowa ZT411', 'Zebra ZT400 series'],
    description: 'Przemysłowa drukarka termotransferowa i termiczna Zebra ZT411 z serii ZT400. Szerokość druku 4" (104 mm), rozdzielczości 203/300/600 dpi, prędkość do 356 mm/s, kolorowy ekran dotykowy 4,3", Wi-Fi 6/6E (opcja), RFID UHF (opcja), druk bezpodkładowy ZeroLiner (opcja). Obsługa ZPL/ZPL II/EPL/ZBI 2.0.',
    ...
    mpn: 'ZT411',
    image: ['https://zt411.pl/images/zt411-1.png', 'https://zt411.pl/images/zt411-2.png', 'https://zt411.pl/images/zt411-3.png'],
    url: 'https://zt411.pl',
  ...
  const faq = {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: 'Jaką rozdzielczość druku wybrać: 203, 300 czy 600 dpi?', acceptedAnswer: { '@type': 'Answer', text: '203 dpi — standardowe etykiety logistyczne, kody kreskowe, adresy. 300 dpi — mniejsze czcionki, QR, DataMatrix, etykiety laboratoryjne. 600 dpi — mikrotekst, znakowanie PCB, etykiety farmaceutyczne, drobne kody 2D. 600 dpi dostępne wyłącznie w ZT411 (nie w ZT421).' } },
  ...
  const webpage = {
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    '@id': 'https://zt411.pl/#webpage',
    url: 'https://zt411.pl',
    name: `Zebra ZT411 — drukarka przemysłowa od ${lowDisplay} zł netto | TAKMA`,
    description: 'Strona produktowa drukarki Zebra ZT411 prowadzona przez autoryzowanego partnera Zebra — TAKMA.',
    inLanguage: 'pl-PL',
    isPartOf: { '@id': 'https://takma.com.pl/#website' },
    about: { '@id': 'https://zt411.pl/#product' },
    primaryImageOfPage: { '@type': 'ImageObject', url: 'https://zt411.pl/images/zt411-1.png' },
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Zebra ZT411', item: 'https://zt411.pl' },
    ],
  }
